 ...
 *
 * @returns {Promise<Document | null>} Promise yielding the resolved drop data, or null on failure
 */
...
// export type DragFetcherCache = FetcherCache<string | FoundryDropData, Document | null>;
